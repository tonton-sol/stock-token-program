...
pub fn process_execute(
    ...
    if is_market_open(current_timestamp) {
        msg!("Market is open.")
    } else {
        msg! {"Market is closed."}
        msg! {"Trading Hours: Monday through Friday, 9:30 am ET to 4:00 pm ET"}

        return Err(StockMarketError::OutsideBusinessHours.into());
    }
